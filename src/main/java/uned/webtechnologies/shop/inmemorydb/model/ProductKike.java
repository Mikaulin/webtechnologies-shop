...
public class ProductKike {
    ...
    public ProductKike(Long id, String foto, String marca, String descripcion, Double priceOrg, Double priceRbj, Double ahorro, int unidades) {
        this.id = id;
        this.foto = foto;
        this.marca = marca;
