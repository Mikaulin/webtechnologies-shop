...
public class PromotionLoader implements ILoader {
    ...
    public void load() {
        ...
        prom.setStartDate(new GregorianCalendar(2018, 8, 1));
        prom.setEndDate(new GregorianCalendar(2018, 8, 31));
        prom.setDiscount(15);
        ...
        navidad18.setStartDate(new GregorianCalendar(2018, 12, 1));
        navidad18.setEndDate(new GregorianCalendar(2018, 12, 21));
        ...
        diaDelPadre.setStartDate(new GregorianCalendar(2019, 3, 19));
        diaDelPadre.setEndDate(new GregorianCalendar(2019, 3, 21));
        ...
        d30.setStartDate(new GregorianCalendar(2019, 2, 5));
        d30.setEndDate(new GregorianCalendar(2019, 5, 21));
        d30.setDiscount(30);
        ...
        d20.setStartDate(new GregorianCalendar(2019, 2, 21));
        d20.setEndDate(new GregorianCalendar(2019, 6, 21));
        d20.setDiscount(20);
        ...
        d15Z.setStartDate(new GregorianCalendar(2019, 1, 1));
        d15Z.setEndDate(new GregorianCalendar(2019, 6, 31));
        d15Z.setDiscount(15);
