    ...
    public void load() {
        ...
        ArrayList<Product> products = new ArrayList<>(
                Arrays.asList(
                        ...
                        new Product(60, "Lavavajillas SMS25FW05E (14 cubiertos - 60 cm - Blanco)", "930 W, A++, 5 programas, 9.5 L/ciclo", "LV001.jpg", 471.99,845, 600, 600, true, brandList.get(5), categoryList.get(1)),
                        ...
                        new Product(60, "Lavavajillas  LP8 825 (14 cubiertos - 60 cm - Inox)", "2100 W, A++, 6 programas, 11 L/ciclo, color Inox.", "LV003.jpg", 449.99, 845, 600, 610, true, brandList.get(2), categoryList.get(1)),
                        new Product(60, "Lavavajillas FFB64706PM (15 cubiertos - 59.6 cm - Inox)", "2200 W, A+++, 11 L/ciclo, 8 programas, aqua stop", "LV004.jpg", 779.99, 850, 596, 610, true, brandList.get(4), categoryList.get(1)),
                        new Product(60, "Lavavajillas integrable ZDT24004FA (13 cubiertos - 59.6 cm)", "1950 W, 5 programas, 9,9 L/ciclo, color negro", "LV005.jpg", 459.99, 818, 596, 555, true, brandList.get(8), categoryList.get(1)),

                        new Product(60, "Placa de inducción HK674400FB (Eléctrica - 59 cm - Negro)", "7400 W, 4 placas, sup. vidrio, control táctil, 14 niv. Potencia", "P001.jpg", 849.99, 55, 590, 520, true, brandList.get(4), categoryList.get(7)),
                        ...
                        new Product(60, "Placa de inducción PID631BB3E (Eléctrica - 59.2 cm)", "3 placas, sup.vidrio, quemador inducción, color negro", "P003.jpg", 489.99, 51, 592, 522, true, brandList.get(5), categoryList.get(7)),
                        new Product(60, "Placa de inducción 3EB865AQ (Eléctrica - 59.2 cm)", "3 placas, sup. vidrio, quemador inducción, 2 años garantía", "P004.jpg", 499.99, 51, 592, 522, true, brandList.get(0), categoryList.get(7)),
                        new Product(60, "Placa de inducción 3EB980AU (Eléctrica - 79.1 cm)", "2 placas, quemador inducción, fun. memoria, bloqueo seg.", "P005.jpg", 1099, 51, 791, 522, true, brandList.get(0), categoryList.get(7)),

                        new Product(60, "Horno ZOP37922XU (57 L - 59.4 cm - Pirolítico - Inox)", "2515 W, A+, 9 programas, control digital, multifunción, grill electr.", "H001.jpg", 349.99, 590, 594, 560, true, brandList.get(8), categoryList.get(3)),
                        ...
                        new Product(60, "Horno HS636GDS1 (71 L - 59.4 cm - Catalítico - Negro)", "3600 W,A, limpieza catalítico, vapor 100%, Deep-frozen, turbogrill", "H003.jpg", 1359,  595, 594, 548, true, brandList.get(6), categoryList.get(3)),
                        ...
                        new Product(60, "Horno HLF 940 (77 L - 89 cm - Hidrolítico - Inox)", "3553 W, A, 9 programas, control digital, visor digital, grill electr.", "H005.jpg", 819.99, 480, 890, 558, true, brandList.get(2), categoryList.get(3)),

                        new Product(60, "Congelador vertical GSN33VL3P", "90 W, No frost, A++, 4 cestos, 2 años garantía, 225 L cap.", "C001.jpg", 821.99,  1760, 600, 650, true, brandList.get(5), categoryList.get(2)),
                        ...
                        new Product(60, "Congelador vertical TGF3 270 inox", "95 W, B, No frost, acero inox., 225 L cap.", "C004.jpg", 626.99, 1900, 595, 650, true, brandList.get(2), categoryList.get(2)),
                        new Product(60, "Congelador Vertical No Frost UI8 F1C W", "A+, color blanco, 2 años garantía,  260 L cap.", "C005.jpg", 499.99, 1875, 595, 630, true, brandList.get(7), categoryList.get(2)),
                        ...
                        new Product(60, "Secadora 3SC871B (7 kg - Condensación - Blanco)", "2800 W, B, 8 programas, pantalla táctil, func. antiarrugas", "S002.jpg", 359.99, 842, 598, 600, true, brandList.get(0), categoryList.get(4)),
                        new Product(60, "Secadora Bomba Calor WTG87239ES (8 kg - Bomba de Calor - Blanco)", "1000 W, A++, 10 programas, pantalla táctil, func. antiarrugas", "S003.jpg", 599.99, 599, 598, 580, true, brandList.get(5), categoryList.get(4)),
                        ...
                        new Product(60, "Secadora TKS1 10 H (8 kg - Bomba de Calor - Blanco)", "650 W, A++, 12 programas, pantalla LED, func. antiarrugas", "S005.jpg", 649.99, 845, 595, 620, true, brandList.get(2), categoryList.get(4)),


                        new Product(60, "Campana Extraible DFT63AC50 60 cm", "146 W, D, 3 niv. potencia, ilum. LED, ruido 68 DB, 2 filtros antigrasa", "CP001.jpg", 129.99, 180, 598, 280, true, brandList.get(5), categoryList.get(5)),
                        ...
                        new Product(60, "Campana integrable GFG-2", "180 W, 3 niv. potencia, ruido 58 DB, ilumin. LED, 1 filtro antigrasa", "CP003.jpg", 129.99,  175, 550, 310, true, brandList.get(2), categoryList.get(5)),
                        ...
                        new Product(60, "Campana Decoración BALAY 3BC694MX 90 cm", "100 W, C, 3 niv. potencia, ruido 65 DB, ilum. LED", "CP005.jpg", 219.99, 900, 900, 500, true, brandList.get(0), categoryList.get(5))
