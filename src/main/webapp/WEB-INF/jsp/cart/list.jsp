                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${carts}" var="cart">
                            <tr id="cart-line-${cart.product.id}">
                                ...
                                <td>
                                    <select class="select select-qty form-control" id="select-qty-${cart.id}" name=""
                                            title="Qty">
                                ...
                                <td>
                                    <a attr-cart-id="${cart.id}" class="btn btn-danger btn-sm cart-product-remove"
                                       href='' id="remove-from-cart-${cart.id}" title="Quitar Producto">
            ...
            <c:if test="${total == null}">
                ...
                <div class="row">
                    <div class="col-md-8 order-md-1">
                        ...
                        <h5> No tiene productos en el carro de la compra. Por favor, para comprar algún producto, debe
                            antes iniciar sesión en el área de cliente.</h5>

                        <br>

                        <a class="btn btn-outline-success" href="${pageContext.request.contextPath}/usuarios/login">Área
                            de cliente
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4">
            ...
            <c:if test="${total > 0.0}">
                ...
                <div class="text-center cart-actions">
                    <a href="${pageContext.request.contextPath}/carrito/orden" class="btn btn-danger btn-block"
                       title="Tramitar pedido">Tramitar pedido</a>
                </div>
            </c:if>
