        ...
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4">
                        ...
                        <div id="estimate_shipping">
                            <table class="table ">
                                ...
                                <tr>
                                    ...
                                    <td colspan="1" class="text-right">20 &euro;</td>
                                </tr>
                            </table>
                        </div>
                    </div>
            ...
            <table class="table table-striped">
                ...
                <tr class="totals key">
                    ...
                    <td colspan="1" class="text-right"><strong>${total + 20} &euro;</strong>
                    </td>
                </tr>
            </table>
            ...
            <div class="text-center cart-actions">
                <a href="${pageContext.request.contextPath}/carrito/confirmacion" class="btn btn-danger btn-block" title="orden de pago">Orden de pago</a>
            </div>
