                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <spring:bind path="lastname1">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                <form:input type="text" path="lastname1" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <spring:bind path="email">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                <form:input type="text" path="email" class="form-control" placeholder=""></form:input>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <spring:bind path="phone">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                <form:input type="text" path="phone" class="form-control" placeholder=""></form:input>
                ...
                <div class="row">
                    <div class="col-md-9 mb-3">
                        ...
                        <spring:bind path="direction">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                <form:input type="text" path="direction" class="form-control"
                                            placeholder=""></form:input>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <spring:bind path="city">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                <form:input type="text" path="city" class="form-control" placeholder=""></form:input>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <spring:bind path="country">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                <form:input type="text" path="country" class="form-control" placeholder=""></form:input>
