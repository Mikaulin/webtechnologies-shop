                ...
                <div class="card mb-3">
                    ...
                    <div class="card-block">
                        <div class="card-text">
                            ...
                            <form action="" accept-charset="UTF-8" id="estimate_shipping_form" autocomplete="off" method="post">

                                <table class="table ">

                                 <tr >
                                    <td colspan="1" class="text-left"><strong>Subtotal</strong></td>
                                    <td colspan="1" class="text-right"><strong><%out.println(totalReb);%>  &euro;</strong></td>
                                    </tr>
            ...
            <div class="col-sm-12 cart-totals">
                <table class="table table-striped">
                    ...
                    <tr class="totals key">
                        ...
                        <td colspan="1" class="text-right"><strong><%out.println(totalReb+ 120.00);%>   &euro;</strong></td>
                    </tr>
                ...
                <div class="text-center cart-actions">
                    ...
                    <a href="https://bootstrap.jumpseller.com" class="btn btn-link btn-block" title="&larr; Continúa Comprando">&larr; Continúa Comprando</a>
                </div>
            </div>
